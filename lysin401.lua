...
local Lang = {
    tr = {
        ...
        sell_title   = "Sat",
        sell_btn     = "💰  Poop'ları Sat!",
        sell_success = "✅ Başarıyla Satıldı!",
        sell_fail    = "⚠ Satış başarısız!",
    },
    en = {
        title        = "Poop Script",
        tab_poop     = "💩 Poop",
...
local CharTabBtn = makeTabBtn(T("tab_char"), 0.25, 2)
local SellTabBtn = makeTabBtn(T("tab_sell"), 0.50, 0)
local LangTabBtn = makeTabBtn(T("tab_lang"), 0.75, -2)
...
SellPage.Size = UDim2.new(1, 0, 1, -108)
SellPage.Position = UDim2.new(0, 0, 0, 108)
SellPage.BackgroundTransparency = 1
SellPage.BorderSizePixel = 0
SellPage.Visible = false
SellPage.Parent = MainFrame

local SellTitle = Instance.new("TextLabel")
SellTitle.Size = UDim2.new(1, -40, 0, 26)
SellTitle.Position = UDim2.new(0, 20, 0, 8)
SellTitle.BackgroundTransparency = 1
SellTitle.Text = T("sell_title")
SellTitle.TextColor3 = Color3.fromRGB(180, 140, 100)
SellTitle.TextSize = 13
SellTitle.Font = Enum.Font.GothamBold
SellTitle.TextXAlignment = Enum.TextXAlignment.Left
SellTitle.Parent = SellPage

local SellStatusLabel = Instance.new("TextLabel")
SellStatusLabel.Size = UDim2.new(1, -40, 0, 30)
SellStatusLabel.Position = UDim2.new(0, 20, 0, 44)
SellStatusLabel.BackgroundTransparency = 1
SellStatusLabel.Text = ""
SellStatusLabel.TextColor3 = Color3.fromRGB(100, 220, 100)
SellStatusLabel.TextSize = 15
SellStatusLabel.Font = Enum.Font.GothamBold
SellStatusLabel.Parent = SellPage

local SellBtn = Instance.new("TextButton")
SellBtn.Size = UDim2.new(1, -40, 0, 80)
SellBtn.Position = UDim2.new(0, 20, 0, 84)
SellBtn.BackgroundColor3 = Color3.fromRGB(20, 100, 40)
SellBtn.Text = T("sell_btn")
SellBtn.TextColor3 = Color3.fromRGB(180, 255, 180)
SellBtn.TextSize = 20
SellBtn.Font = Enum.Font.GothamBold
SellBtn.BorderSizePixel = 0
SellBtn.Parent = SellPage
...
SellGradient.Color = ColorSequence.new({
    ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 160, 60)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(10, 80, 25))
})
SellGradient.Rotation = 90
SellGradient.Parent = SellBtn

local SellStroke = Instance.new("UIStroke", SellBtn)
SellStroke.Color = Color3.fromRGB(80, 220, 100)
SellStroke.Transparency = 0.3
SellStroke.Thickness = 1.5

SellBtn.MouseEnter:Connect(function()
    TweenService:Create(SellBtn, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(30, 130, 55)}):Play()
end)
SellBtn.MouseLeave:Connect(function()
    TweenService:Create(SellBtn, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(20, 100, 40)}):Play()
end)

SellBtn.MouseButton1Click:Connect(function()
    local ok, _ = pcall(function()
        local args = { buffer.fromstring("\003\a") }
    ...
    if ok then
        SellStatusLabel.Text = T("sell_success")
        SellStatusLabel.TextColor3 = Color3.fromRGB(100, 220, 100)
    else
        SellStatusLabel.Text = T("sell_fail")
        SellStatusLabel.TextColor3 = Color3.fromRGB(255, 100, 100)
    end
...
local function setTab(tab)
    PoopPage.Visible = false; CharPage.Visible = false; LangPage.Visible = false; SellPage.Visible = false
    ...
    SellTabBtn.BackgroundColor3 = Color3.fromRGB(30, 22, 40); SellTabBtn.TextColor3 = Color3.fromRGB(100, 120, 100)
    ...
    elseif tab == "sell" then
        ...
        SellTabBtn.BackgroundColor3 = Color3.fromRGB(15, 80, 30)
        SellTabBtn.TextColor3 = Color3.fromRGB(150, 255, 160)
...
SellTabBtn.MouseButton1Click:Connect(function() setTab("sell") end)
...
-- ─── POOP BUTONU (STOP DESTEKLİ) ───
PoopBtn.MouseButton1Click:Connect(function()
    if isOnCooldown then return end

    -- Eğer gönderme devam ediyorsa DURDUR
    if isSending then
        isSending = false
        PoopBtn.Text = T("poop_btn")
        PoopBtn.TextColor3 = Color3.fromRGB(255, 230, 150)
    ...
    -- Butonu STOP'a çevir
    PoopBtn.Text = "⏹  Stop"
    PoopBtn.TextColor3 = Color3.fromRGB(255, 100, 100)
    PoopBtn.BackgroundColor3 = Color3.fromRGB(140, 30, 30)
    ...
    for i = 1, poopCount do
        if not isSending then break end  -- Durduruldu mu kontrol et
        ...
        if i < poopCount and isSending then
            local delay = 0.4; local steps = 40
            for t = steps, 1, -1 do
                if not isSending then break end  -- Bekleme sırasında da durdur
